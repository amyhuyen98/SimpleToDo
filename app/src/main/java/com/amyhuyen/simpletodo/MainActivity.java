package com.amyhuyen.simpletodo;
...
public class MainActivity extends AppCompatActivity {
    ...
    // action: adding items to the list
    ...
    // action: removing items from the list
    ...
    // read the items in the list, as stored in the file
    ...
    // write the items currently in the list to a file
